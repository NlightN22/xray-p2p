...
- Runtime success compares full normalized routing, inbound, outbound, and user
  credential payloads observed at the API boundary with independently compiled
  Desired artifacts and production-published Live artifacts.
