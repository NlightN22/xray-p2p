...
xp2p client
  Subcommands: install, disable, enable, remove, list, run, service, state, render, debug, export, import, deploy, redirect, forward, reverse, mode, dns-forward (Linux only)
