...
def _cleanup_host(host: Host) -> None:
    ...
    cleanup_paths = [
        ...
        helpers.CONFIG_ROOT / "xp2p-client.state.json.lkg",
        helpers.CONFIG_ROOT / "xp2p-server.state.json.lkg",
        ...
        helpers.CLIENT_CONFIG_DIR / "inbounds.json.lkg",
        helpers.CLIENT_CONFIG_DIR / "outbounds.json.lkg",
        helpers.CLIENT_CONFIG_DIR / "routing.json.lkg",
        helpers.CLIENT_CONFIG_DIR / "logs.json.lkg",
        helpers.SERVER_CONFIG_DIR / "inbounds.json.lkg",
        helpers.SERVER_CONFIG_DIR / "outbounds.json.lkg",
        helpers.SERVER_CONFIG_DIR / "routing.json.lkg",
        helpers.SERVER_CONFIG_DIR / "logs.json.lkg",
