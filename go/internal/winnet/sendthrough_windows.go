...
func DefaultSendThroughIPv4(ctx context.Context) (string, error) {
	script := strings.Join([]string{
		...
		`$def = Get-NetRoute -DestinationPrefix "0.0.0.0/0" -AddressFamily IPv4 | Where-Object { $_.NextHop -ne "0.0.0.0" } | Sort-Object RouteMetric,ifMetric | Select-Object -First 1`,
