...
func buildMutationRepeatPolicies() map[string]mutationRepeatPolicy {
	...
	return map[string]mutationRepeatPolicy{
		...
		"xp2p client mode":                         advances("repeating the mode records a fresh service-layer apply request"),
		...
		"xp2p server mode":                         advances("repeating the mode records a fresh service-layer apply request"),
