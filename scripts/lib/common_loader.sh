...
XRAY_COMMON_LOADER_DEFAULT_BUNDLE="scripts/lib/bootstrap.sh scripts/lib/common.sh scripts/lib/interface_detect.sh scripts/lib/ip_show.sh scripts/lib/lan_detect.sh scripts/lib/network_interfaces.sh scripts/lib/user_list.sh scripts/lib/common_loader.sh"
